...
$orbitScript = Join-Path $PSScriptRoot 'orbit_instagram_directs.py'
...
Write-Output 'Collegamento manuale avviato. Post e reel vengono messi like solo dopo il clic nella dashboard.'
